---
title: "Plot `vcf_clone_detect.py` results for *P. acuta* RNA-seq samples from this study and SRA"
...
heatmap.2(x=tmp.mat,
          ...
          col=cividis(length(seq(70, 100, 0.1))-1),
          breaks=seq(70, 100, 0.1),
...
heatmap.2(x=tmp.mat,
          Rowv = simScore.dendro,
          Colv = simScore.dendro,
          col=c(rep(cividis(5)[1], length(seq(70.1, 80.6,  0.1))),
